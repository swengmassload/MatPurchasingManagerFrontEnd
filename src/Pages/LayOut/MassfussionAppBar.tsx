...
<Typography
         ...
         sx={{
            fontFamily: 'Inter',  fontSize: '22px',  fontWeight: 800,  lineHeight: '26.63px',  letterSpacing: '-0.015em',textAlign: 'left',
           }}>
        ...
        <Typography
         variant="h6" color="inherit"
         sx={{
            fontFamily: 'Inter',  fontSize: '22px',  fontWeight: 500,  lineHeight: '26.63px',  letterSpacing: '-0.015em',textAlign: 'left',mr: 2
           }}> {"@massload.com"}
