//These values are auto generated from the database and should not be changed manually
//https://localhost:7171/api/v1/GetClaimsAndValues from RegistrationManager API

export const EstablishedClaims = {
