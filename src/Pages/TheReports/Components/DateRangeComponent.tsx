...
const DateRangeComponent = ({startDate, endDate,setStartDate, setEndDate,caption}:DateRangeComponentProps) => {
    return (
    <Box sx={{ ...SimpleBoxborder,  gap: 2,
    width: "100%",justifyContent: "center",alignItems: "center",display: "flex",flexDirection: "row",padding: "1rem",}}>

    <LocalizationProvider dateAdapter={AdapterDayjs}>

      <Box sx={{ width: '50%', display: 'flex', flexDirection: 'column', gap: '1rem', justifyContent: 'center', alignItems: 'center', padding: '1rem', }}>
        <DatePicker
